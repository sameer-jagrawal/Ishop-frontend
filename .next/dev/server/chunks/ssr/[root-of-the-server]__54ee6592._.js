...
"[project]/src/app/(user-auth)/login/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const submitHandler = async (e)=>{
        ...
        try {
            ...
            // SYNC CART
            const cartRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["client"].post("cart/sync", {
                localCart: JSON.stringify(localCart)
            });
            const cartData = cartRes?.data?.data?.cart || [];
            let finalTotal = 0;
            let originalTotal = 0;
            const items = cartData.filter((item)=>item?.productId).map((item)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__54ee6592._.js.map