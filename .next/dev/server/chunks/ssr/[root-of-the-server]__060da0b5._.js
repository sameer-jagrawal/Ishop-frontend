...
function Status({ value, id, feild, type }) {
    ...
    function activeHandler() {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["client"].put(`${type}/update/${id}`, {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["notify"])(feild + "  Updated succesfully", response.data.success);
            if (response.data.success) {
                router.refresh();
            }
        }).catch((error)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["notify"])("Not updated", false);
            console.log(error);
        });
    }
    const lable = {
...
"[project]/src/app/(admin)/admin/product/view/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__060da0b5._.js.map