...
const cartSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    ...
    reducers: {
        addToCart: (state, { payload })=>{
            ...
            state.originalTotal += Number(payload?.original_price);
            state.finalTotal += Number(payload?.final_price);
        },
        emptyCart: (state)=>{},
        qtyChanges: ()=>{}
    }
});
const { addToCart, emptyCart, qtyChanges } = cartSlice.actions;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d86dba7._.js.map