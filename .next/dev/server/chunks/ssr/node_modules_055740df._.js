...
function Virtual({ swiper, extendParams, on, emit }) {
    ...
    on('init update resize', ()=>{
        if (!swiper.params.virtual.enabled) return;
        if (swiper.params.cssMode) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["b"])(swiper.wrapperEl, '--swiper-virtual-size', `${swiper.virtualSize}px`);
        }
    });
    Object.assign(swiper.virtual, {
        appendSlide,
...
/* eslint-disable consistent-return */ function Keyboard({ swiper, extendParams, on, emit }) {
    ...
    function handle(event) {
        ...
        if (swiper.params.keyboard.onlyInViewport && (isPageUp || isPageDown || isArrowLeft || isArrowRight || isArrowUp || isArrowDown)) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["d"])(swiper.el, `.${swiper.params.slideClass}, swiper-slide`).length > 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["d"])(swiper.el, `.${swiper.params.slideActiveClass}`).length === 0) {
                return undefined;
            }
            const el = swiper.el;
            ...
            const swiperOffset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["f"])(el);
...
/* eslint-disable consistent-return */ function Mousewheel({ swiper, extendParams, on, emit }) {
    ...
    let timeout;
    let lastScrollTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["h"])();
    ...
    function animateSlider(newEvent) {
        ...
        if (swiper.params.mousewheel.thresholdTime && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["h"])() - lastScrollTime < swiper.params.mousewheel.thresholdTime) {
        ...
        if (newEvent.delta >= 6 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["h"])() - lastScrollTime < 60) {
    ...
    function handle(event1) {
        ...
        if (!swiper.params.freeMode || !swiper.params.freeMode.enabled) {
            ...
            const newEvent = {
                time: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["h"])(),
        ...
        const initButton = (el, dir)=>{
            if (el) {
                if (params.addIcons && el.matches('.swiper-button-next,.swiper-button-prev') && !el.querySelector('svg')) {
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["s"])(tempEl, arrowSvg);
...
function Pagination({ swiper, extendParams, on, emit }) {
    ...
    function onBulletClick(e) {
        ...
        e.preventDefault();
        const index = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["j"])(bulletEl) * swiper.params.slidesPerGroup;
        if (swiper.params.loop) {
    ...
    function update() {
        ...
        if (params.type === 'bullets' && swiper.pagination.bullets && swiper.pagination.bullets.length > 0) {
            ...
            if (params.dynamicBullets) {
                bulletSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["i"])(bullets[0], swiper.isHorizontal() ? 'width' : 'height', true);
                el.forEach((subEl)=>{
            ...
            if (el.length > 1) {
                bullets.forEach((bullet)=>{
                    const bulletIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["j"])(bullet);
    ...
    function init() {
        ...
        if (swiper.params.uniqueNavElements && typeof params.el === 'string' && Array.isArray(el) && el.length > 1) {
            ...
            if (el.length > 1) {
                el = el.find((subEl)=>{
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["d"])(subEl, '.swiper')[0] !== swiper.el) return false;
                    return true;
                });
            }
        }
...
function Scrollbar({ swiper, extendParams, on, emit }) {
    ...
    function setDragPosition(e) {
        ...
        const { el } = scrollbar;
        let positionRatio;
        positionRatio = (getPointerPosition(e) - (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["f"])(el)[swiper.isHorizontal() ? 'left' : 'top'] - (dragStartPos !== null ? dragStartPos : dragSize / 2)) / (trackSize - dragSize);
    ...
    function init() {
        ...
        if (el) {
            el.classList[swiper.enabled ? 'remove' : 'add'](...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["k"])(swiper.params.scrollbar.lockClass));
        }
    }
    function destroy() {
        const params = swiper.params.scrollbar;
        ...
        if (el) {
            el.classList.remove(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["k"])(swiper.isHorizontal() ? params.horizontalClass : params.verticalClass));
        }
        disableDraggable();
    }
    on('changeDirection', ()=>{
    ...
    const enable = ()=>{
        swiper.el.classList.remove(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["k"])(swiper.params.scrollbar.scrollbarDisabledClass));
        if (swiper.scrollbar.el) {
            swiper.scrollbar.el.classList.remove(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["k"])(swiper.params.scrollbar.scrollbarDisabledClass));
        }
        init();
        updateSize();
        setTranslate();
    ...
    const disable = ()=>{
        swiper.el.classList.add(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["k"])(swiper.params.scrollbar.scrollbarDisabledClass));
        if (swiper.scrollbar.el) {
            swiper.scrollbar.el.classList.add(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["k"])(swiper.params.scrollbar.scrollbarDisabledClass));
        }
        destroy();
    };
...
function Zoom({ swiper, extendParams, on, emit }) {
    ...
    function onGestureStart(e) {
        ...
        if (!gesture.slideEl) {
            ...
            if (imageEl) {
                gesture.imageWrapEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["d"])(gesture.imageEl, `.${params.containerClass}`)[0];
            } else {
    ...
    function onTouchMove(e) {
        ...
        if (!image.isMoved) {
            ...
            image.startX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["l"])(gesture.imageWrapEl, 'x') || 0;
            image.startY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["l"])(gesture.imageWrapEl, 'y') || 0;
    ...
    function zoomIn(e) {
        ...
        if (e && !(currentScale === 1 && forceZoomRatio)) {
            ...
            offsetX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["f"])(gesture.slideEl).left + window.scrollX;
            offsetY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["f"])(gesture.slideEl).top + window.scrollY;
    ...
    function setTransition(duration, byController) {
        ...
        function setControlledTransition(c) {
            ...
            if (duration !== 0) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["o"])(c.wrapperEl, ()=>{
        ...
        swiper.pagination.bullets.forEach((bulletEl)=>{
            if (swiper.params.pagination.clickable) {
                ...
                if (!swiper.params.pagination.renderBullet) {
                    ...
                    addElLabel(bulletEl, params.paginationBulletMessage.replace(/\{\{index\}\}/, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["j"])(bulletEl) + 1));
                }
            }
...
function Thumb({ swiper, extendParams, on }) {
    ...
    function init() {
        ...
        } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["p"])(thumbsParams.swiper)) {
...
function freeMode({ swiper, extendParams, emit, once }) {
    ...
    function onTouchEnd({ currentPos }) {
        ...
        // Time diff
        const touchEndTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["h"])();
        ...
        if (params.freeMode.momentum) {
            if (data.velocities.length > 1) {
                ...
                if (time > 150 || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["h"])() - lastMoveEvent.time > 300) {
                    swiper.velocity = 0;
                }
            } else {
                swiper.velocity = 0;
            ...
            if (params.freeMode.momentumBounce && doBounce) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["o"])(wrapperEl, ()=>{
...
function effectVirtualTransitionEnd({ swiper, duration, transformElements, allSlides }) {
    ...
    if (swiper.params.virtualTranslate && duration !== 0) {
        ...
        transitionEndTarget.forEach((el)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["o"])(el, ()=>{
...
function EffectCube({ swiper, extendParams, on }) {
    ...
    const setTranslate = ()=>{
        ...
        const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["a"])(swiper);
...
function EffectFlip({ swiper, extendParams, on }) {
    ...
    const setTranslate = ()=>{
        ...
        const rotateFix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["a"])(swiper);
        for(let i = 0; i < slides.length; i += 1){
            const slideEl = slides[i];
            let progress = slideEl.progress;
            if (swiper.params.flipEffect.limitRotation) {
...
__turbopack_context__.s([
    "Navigation",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$modules$2f$navigation$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$modules$2f$navigation$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/swiper/modules/navigation.mjs [app-rsc] (ecmascript)");
}),
...
__turbopack_context__.s([
    "Pagination",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$modules$2f$pagination$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$modules$2f$pagination$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/swiper/modules/pagination.mjs [app-rsc] (ecmascript)");
}),
...
__turbopack_context__.s([
    "Scrollbar",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$modules$2f$scrollbar$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$modules$2f$scrollbar$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/swiper/modules/scrollbar.mjs [app-rsc] (ecmascript)");
}),
"[project]/node_modules/swiper/modules/a11y.mjs [app-rsc] (ecmascript) <export default as A11y>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "A11y",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$modules$2f$a11y$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$modules$2f$a11y$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/swiper/modules/a11y.mjs [app-rsc] (ecmascript)");
}),
...
function Observer({ swiper, extendParams, on, emit }) {
    ...
    const init = ()=>{
        ...
        if (swiper.params.observeParents) {
            const containerParents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["d"])(swiper.hostEl);
...
function updateSlides() {
    ...
    if (params.centeredSlides && params.cssMode) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["b"])(wrapperEl, '--swiper-centered-offset-before', '');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["b"])(wrapperEl, '--swiper-centered-offset-after', '');
    }
    // set cssMode offsets
    if (params.cssMode) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["b"])(wrapperEl, '--swiper-slides-offset-before', `${offsetBefore}px`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["b"])(wrapperEl, '--swiper-slides-offset-after', `${offsetAfter}px`);
    }
    ...
    for(let i = 0; i < slidesLength; i += 1){
        ...
        if (slide) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["q"])(slide, 'display') === 'none') continue; // eslint-disable-line
        }
    ...
    if (params.centeredSlides && params.cssMode && !params.centeredSlidesBounds) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["b"])(wrapperEl, '--swiper-centered-offset-before', `${-snapGrid[0]}px`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["b"])(wrapperEl, '--swiper-centered-offset-after', `${swiper.size / 2 - slidesSizesGrid[slidesSizesGrid.length - 1] / 2}px`);
...
function getSwiperTranslate(axis = this.isHorizontal() ? 'x' : 'y') {
    ...
    let currentTranslate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["l"])(wrapperEl, axis);
...
function onTouchStart(event) {
    ...
    data.touchStartTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["h"])();
    swiper.allowClick = true;
    swiper.updateSize();
...
function onTouchEnd(event) {
    ...
    data.lastClickTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["h"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["n"])(()=>{
...
class Swiper {
    ...
    getSlideIndex(slideEl) {
        ...
        const slides = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["e"])(slidesEl, `.${params.slideClass}, swiper-slide`);
        const firstSlideIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["j"])(slides[0]);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["j"])(slideEl) - firstSlideIndex;
    }
    ...
    if (needNavigationInit) {
        if (swiper.isElement) {
            if (!nextEl || typeof nextEl === 'string') {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["s"])(nextEl, swiper.navigation.arrowSvg);
            ...
            if (!prevEl || typeof prevEl === 'string') {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["s"])(prevEl, swiper.navigation.arrowSvg);
...
const Swiper = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["forwardRef"])(({ className, tag: Tag = 'div', wrapperTag: WrapperTag = 'div', children, onSwiper, ...rest } = {}, externalElRef)=>{
...
const SwiperSlide = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["forwardRef"])(({ tag: Tag = 'div', children, className = '', swiper, zoom, lazy, virtualIndex, swiperSlideIndex, ...rest } = {}, externalRef)=>{
...
const __TURBOPACK__layout__$23$4__ = ()=>__turbopack_context__.r("[project]/src/app/(user)/layout.jsx [app-rsc] (ecmascript, Next.js Server Component)");
...
const __TURBOPACK__page__$23$8__ = ()=>__turbopack_context__.r("[project]/src/app/(user)/singleProduct/[slug]/page.jsx [app-rsc] (ecmascript, Next.js Server Component)");
;
;
;
;
        ...
        "children": [
                                ...
                                "children": [
                                    ...
                                    {},
                                    {
                                        ...
                                        "page": [
                                            ...
                                            "[project]/src/app/(user)/singleProduct/[slug]/page.jsx"
                                        ]
                                    }
                                ]
                            },
            ...
            },
            {
                ...
                "layout": [
                    ...
                    "[project]/src/app/(user)/layout.jsx"
                ],
                "not-found": [
...
const routeModule = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$module$2e$compiled$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppPageRouteModule"]({
    definition: {
        ...
        page: "/(user)/singleProduct/[slug]/page",
        pathname: "/singleProduct/[slug]",
...
async function handler(req, res, ctx) {
    ...
    let srcPage = "/(user)/singleProduct/[slug]/page";
...
//# sourceMappingURL=node_modules_055740df._.js.map