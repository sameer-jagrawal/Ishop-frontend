...
(()=>{
    const e = new Error("Cannot find module 'next/nevigation'");
...
function AddAddressPage() {
    ...
    const handleSubmit = (e)=>{
        e.preventDefault();
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["client"].post("user/address", form).then((response)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__84ee291e._.js.map