...
function Status(t0) {
    ...
    if ($[0] !== "62f99de77984f858fcc3e07f5464759edc1ed7a2f39b60c3decf2849dea5c04c") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "62f99de77984f858fcc3e07f5464759edc1ed7a2f39b60c3decf2849dea5c04c";
    }
    const { status, id } = t0;
    ...
    if ($[1] !== id || $[2] !== router) {
        t1 = function activeHandler() {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`http://localhost:5000/api/category/update-status/${id}`, {
                feild: "status"
            }).then({
...
//# sourceMappingURL=src_app_components_admin%20components_Status_jsx_7b26bf57._.js.map