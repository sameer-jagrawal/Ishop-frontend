...
function DeleteBtn(t0) {
    ...
    if ($[0] !== "45f5c77989efe5e854f4916dc9fc049b3ce329c4d380bb3de3dbd57297c8efcf") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "45f5c77989efe5e854f4916dc9fc049b3ce329c4d380bb3de3dbd57297c8efcf";
    }
    const { id } = t0;
    ...
    if ($[1] !== id || $[2] !== router) {
        t1 = function deleteHandler() {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire({
                ...
                "DeleteBtn[deleteHandler > (anonymous)()]": (result)=>{
                    if (result.isConfirmed) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:5000/api/category/delete/${id}`).then({
...
_c = DeleteBtn;
function _DeleteBtnDeleteHandlerAnonymousAnonymous(errro) {
    console.log(error);
}
var _c;
...
//# sourceMappingURL=src_app_components_admin%20components_DeleteBtn_jsx_efdfba1f._.js.map