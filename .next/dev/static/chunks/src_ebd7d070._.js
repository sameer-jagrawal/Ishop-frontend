...
async function getCategories() {
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["client"].get("category");
...
async function getBrand() {
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["client"].get("brand");
        return response.data;
    } catch (error) {
        console.log(error);
    }
...
async function getProduct() {
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["client"].get("product");
...
"[project]/src/app/(admin)/admin/product/edit/[edit]/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Page() {
    ...
    const long_discription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    // --- Selected IDs (FIXED) ---
    const [selectedCategory, setSelectedCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // single ID
...
_s(Page, "tIzezqAHJUG86II/aRx4b7QWzh8=", false, function() {
    return [
...
//# sourceMappingURL=src_ebd7d070._.js.map