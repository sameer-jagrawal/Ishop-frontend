...
"[project]/src/app/(user-auth)/register/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RegisterPage() {
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "RegisterPage[handleChanges]": (e)=>{
                setForm({
                    "RegisterPage[handleChanges > setForm()]": (prev)=>({
                            ...prev,
                            [e.target.name]: e.target.value
                        })
                }["RegisterPage[handleChanges > setForm()]"]);
            }
        })["RegisterPage[handleChanges]"];
        $[2] = t1;
    } else {
        t1 = $[2];
    }
    const handleChanges = t1;
    let t2;
    if ($[3] !== form || $[4] !== router) {
        t2 = ({
            "RegisterPage[submitHandler]": (e_0)=>{
                e_0.preventDefault();
                setLoader(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["client"].post("user/register", form).then({
                    "RegisterPage[submitHandler > (anonymous)()]": (response)=>{
                ...
                }["RegisterPage[submitHandler > (anonymous)()]"]).catch(_RegisterPageSubmitHandlerAnonymous).finally({
                    "RegisterPage[submitHandler > (anonymous)()]": ()=>{
                        setLoader(false);
                    }
                }["RegisterPage[submitHandler > (anonymous)()]"]);
            }
        })["RegisterPage[submitHandler]"];
        $[3] = form;
        $[4] = router;
        $[5] = t2;
    } else {
    ...
    if ($[18] !== t8) {
        t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full max-w-2xl bg-white rounded-[28px] shadow-lg p-8 md:p-10 border border-gray-100",
                children: [
                    t3,
                    t8,
                    t9
...
_s(RegisterPage, "eVYwiossKcFvsLf2ggFIZ1rpnrY=", false, function() {
    return [
...
//# sourceMappingURL=src_3dbf04b5._.js.map